...
<body>
    <nav class="navbar navbar-expand-lg bg-body-tertiary">
        <div class="container-fluid">
            <a class="navbar-brand" href="#">Abdo Blog</a>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                ...
                <form method="GET" action="{{route('posts.index')}}" class="d-flex mx-auto w-50" role="search">
                    <input class="form-control me-2" type="text" name="search" placeholder="Search" aria-label="Search" required>
                    <!-- <input class="form-control me-2" type="text" name="result"> -->
